export const getMenu = () => {
    return `<ul class="menu">
            ...
            <li><a href="/pages/grid/grid.html" class="menu__item menu__item--loggedOut">Feed</a></li>
            <li><a href="/pages/userLogin.html"
                    class="menu__item menu__item--loggedOut">Login/Register</a>
            </li>
            <li><a href="/pages/add-post/add-post.html" class="menu__item menu__item--loggedOut">Add a
                    Post</a></li>
