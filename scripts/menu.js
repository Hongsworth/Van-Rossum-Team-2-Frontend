export const getMenu = () => {
    return `<ul class="menu">
            <li><a href="Van-Rossum-Team-2-Frontend/index.html" class="menu__item">Home</a></li>
            <li><a href="Van-Rossum-Team-2-Frontend/pages/grid/grid.html" class="menu__item">Feed</a></li>
            <li><a href="#"
                    class="menu__item menu__item--loggedOut">Login/Register</a>
            </li>
            <li><a href="#" class="menu__item menu__item--loggedIn">Add a
                    Post</a></li>
            <li><a href="Van-Rossum-Team-2-Frontend/pages/user-profile/user-profile.html" class="menu__item">Profile</a>
            </li>
